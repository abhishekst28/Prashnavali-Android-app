...
public class AnimatorInflaterCompat {
    ...
    private static int inferValueTypeOfKeyframe(Resources res, Resources.Theme theme, AttributeSet attrs, XmlPullParser parser) {
        ...
        TypedValue keyframeValue = TypedArrayUtils.peekNamedValue(a, parser, AppMeasurementSdk.ConditionalUserProperty.VALUE, 0);
    ...
    private static Keyframe loadKeyframe(Context context, Resources res, Resources.Theme theme, AttributeSet attrs, int valueType, XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        if (!hasValue) {
            ...
            keyframe2 = Keyframe.ofFloat(fraction, TypedArrayUtils.getNamedFloat(a, parser, AppMeasurementSdk.ConditionalUserProperty.VALUE, 0, 0.0f));
        } else if (valueType == 1 || valueType == 3) {
            keyframe2 = Keyframe.ofInt(fraction, TypedArrayUtils.getNamedInt(a, parser, AppMeasurementSdk.ConditionalUserProperty.VALUE, 0, 0));
        }
