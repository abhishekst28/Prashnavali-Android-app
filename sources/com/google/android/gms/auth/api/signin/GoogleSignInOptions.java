...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    public boolean equals(java.lang.Object r4) {
        ...
        L_0x0004:
            ...
            java.util.ArrayList<com.google.android.gms.auth.api.signin.internal.GoogleSignInOptionsExtensionParcelable> r1 = r3.zaad     // Catch:{ ClassCastException -> 0x008a }
            int r1 = r1.size()     // Catch:{ ClassCastException -> 0x008a }
            if (r1 > 0) goto L_0x0089
            java.util.ArrayList<com.google.android.gms.auth.api.signin.internal.GoogleSignInOptionsExtensionParcelable> r1 = r4.zaad     // Catch:{ ClassCastException -> 0x008a }
            int r1 = r1.size()     // Catch:{ ClassCastException -> 0x008a }
            if (r1 <= 0) goto L_0x0018
            goto L_0x0089
        L_0x0018:
            java.util.ArrayList<com.google.android.gms.common.api.Scope> r1 = r3.zaw     // Catch:{ ClassCastException -> 0x008a }
            int r1 = r1.size()     // Catch:{ ClassCastException -> 0x008a }
            java.util.ArrayList r2 = r4.getScopes()     // Catch:{ ClassCastException -> 0x008a }
            ...
            goto L_0x0088
        L_0x0035:
            android.accounts.Account r1 = r3.zax     // Catch:{ ClassCastException -> 0x008a }
            if (r1 != 0) goto L_0x0040
            android.accounts.Account r1 = r4.getAccount()     // Catch:{ ClassCastException -> 0x008a }
            if (r1 != 0) goto L_0x0086
        L_0x003f:
            goto L_0x004d
        L_0x0040:
            android.accounts.Account r1 = r3.zax     // Catch:{ ClassCastException -> 0x008a }
            android.accounts.Account r2 = r4.getAccount()     // Catch:{ ClassCastException -> 0x008a }
            boolean r1 = r1.equals(r2)     // Catch:{ ClassCastException -> 0x008a }
            if (r1 == 0) goto L_0x0086
            goto L_0x003f
        L_0x004d:
            java.lang.String r1 = r3.zaab     // Catch:{ ClassCastException -> 0x008a }
            boolean r1 = android.text.TextUtils.isEmpty(r1)     // Catch:{ ClassCastException -> 0x008a }
            if (r1 == 0) goto L_0x0060
            java.lang.String r1 = r4.getServerClientId()     // Catch:{ ClassCastException -> 0x008a }
            boolean r1 = android.text.TextUtils.isEmpty(r1)     // Catch:{ ClassCastException -> 0x008a }
            if (r1 == 0) goto L_0x0086
            goto L_0x006c
        L_0x0060:
            java.lang.String r1 = r3.zaab     // Catch:{ ClassCastException -> 0x008a }
            java.lang.String r2 = r4.getServerClientId()     // Catch:{ ClassCastException -> 0x008a }
            boolean r1 = r1.equals(r2)     // Catch:{ ClassCastException -> 0x008a }
            if (r1 == 0) goto L_0x0086
        L_0x006c:
            boolean r1 = r3.zaaa     // Catch:{ ClassCastException -> 0x008a }
            boolean r2 = r4.isForceCodeForRefreshToken()     // Catch:{ ClassCastException -> 0x008a }
            if (r1 != r2) goto L_0x0086
            boolean r1 = r3.zay     // Catch:{ ClassCastException -> 0x008a }
            boolean r2 = r4.isIdTokenRequested()     // Catch:{ ClassCastException -> 0x008a }
            if (r1 != r2) goto L_0x0086
            boolean r1 = r3.zaz     // Catch:{ ClassCastException -> 0x008a }
            boolean r4 = r4.isServerAuthCodeRequested()     // Catch:{ ClassCastException -> 0x008a }
