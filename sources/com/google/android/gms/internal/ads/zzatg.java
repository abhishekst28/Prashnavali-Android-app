...
public final class zzatg extends ContextWrapper {
    ...
    private WeakReference<Activity> zzduz = new WeakReference<>((Object) null);
    ...
    private final synchronized android.content.Intent zzd(android.content.Intent r3) {
        /*
            r2 = this;
            monitor-enter(r2)
            android.content.Context r0 = r2.zzduy     // Catch:{ all -> 0x0039 }
            ...
            android.content.Context r1 = r2.zzduy     // Catch:{ all -> 0x0039 }
        ...
        L_0x0039:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzatg.zzd(android.content.Intent):android.content.Intent");
    }

    private final synchronized void zze(Intent intent) {
        Activity activity = (Activity) this.zzduz.get();
        if (activity == null) {
