...
public final class zzbab {
    private static final zzbad<Map<String, ?>> zzecf = new zzbaa();
    ...
    public static String zza(zzbac zzbac) {
        return zzk(zzbac);
    }
    ...
    private static String zzk(Object obj) {
        ...
        try {
            ...
            zzaxy.zzc("Error when writing JSON.", e);
            return null;
        }
    }
                ...
                if (opt instanceof Boolean) {
                    ...
                    if (!(jSONArray == null || jSONArray.length() == 0)) {
                        ...
                        if (obj == null) {
                            ...
                            zzaxy.zzfe(valueOf.length() != 0 ? "Expected JSONArray with at least 1 non-null element for key:".concat(valueOf) : new String("Expected JSONArray with at least 1 non-null element for key:"));
                        } else if (obj instanceof JSONObject) {
                            ...
                            zzaxy.zzfe(String.format("JSONArray with unsupported type %s for key:%s", new Object[]{obj.getClass().getCanonicalName(), next}));
                        }
                    }
                    ...
                    zzaxy.zzfe(valueOf2.length() != 0 ? "Unsupported type for key:".concat(valueOf2) : new String("Unsupported type for key:"));
                }
            }
        }
        return bundle;
