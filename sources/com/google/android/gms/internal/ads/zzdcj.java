...
final /* synthetic */ class zzdcj implements Callable {
    static final Callable zzgtz = new zzdcj();
    ...
    public final Object call() {
        ...
        if (((Boolean) zzwe.zzpu().zzd(zzaat.zzcmk)).booleanValue()) {
        ...
        bundle.putInt("web_view_count", zzp.zzkt().zzwi());
        return new zzdch(bundle);
    }
}
