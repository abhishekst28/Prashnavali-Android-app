...
final class zzdet implements zzden<zzdeq> {
    ...
    public zzdet(zzdvw zzdvw, Context context) {
        this.zzgay = zzdvw;
        this.zzvr = context;
    }

    public final zzdvt<zzdeq> zzaqs() {
        return this.zzgay.zze(new zzdes(this));
    }
    ...
    public final /* synthetic */ zzdeq zzarj() throws Exception {
        ...
        if (packageManager != null) {
            ...
            if (queryIntentActivities != null && resolveActivity != null) {
                ...
                return new zzdeq(z2, z3, country, startsWith, isLatchsky, isSidewinder, language, arrayList, zza, zzy, str, z, Build.MODEL, zzp.zzkr().zzxw());
            }
        }
        z = false;
        return new zzdeq(z2, z3, country, startsWith, isLatchsky, isSidewinder, language, arrayList, zza, zzy, str, z, Build.MODEL, zzp.zzkr().zzxw());
