...
public abstract class zzdv implements zzdw {
    protected static volatile zzex zzwg = null;
    ...
    /* access modifiers changed from: protected */
    public abstract zzcf.zza.C0004zza zza(Context context, zzby.zza zza);

    /* access modifiers changed from: protected */
    public abstract zzcf.zza.C0004zza zzb(Context context, View view, Activity activity);

    /* access modifiers changed from: protected */
    public abstract zzfd zzb(MotionEvent motionEvent) throws zzeu;

    /* access modifiers changed from: protected */
    public abstract zzcf.zza.C0004zza zzc(Context context, View view, Activity activity);
