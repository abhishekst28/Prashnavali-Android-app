...
final class zzlo {
    ...
    private static boolean zza(zzjy zzjy, boolean z) throws IOException, InterruptedException {
        ...
        while (true) {
            ...
            if (zzja >= j) {
                i2 += i3;
                if (readInt != zzkr.zzatp) {
                    if (readInt != zzkr.zzaty && readInt != zzkr.zzaua) {
                        if ((((long) i2) + zzja) - j >= ((long) i)) {
                            break;
                        }
                        int i4 = (int) (zzja - j);
                        i2 += i4;
                        if (readInt == zzkr.zzaso) {
                            if (i4 < 8) {
                                return false;
                            }
                            zzpk.reset(i4);
