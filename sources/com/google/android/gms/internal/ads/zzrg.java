...
public final class zzrg {
    ...
    public final void initialize(android.content.Context r5) {
        /*
            r4 = this;
            java.lang.Object r0 = r4.zzbsv
            monitor-enter(r0)
            boolean r1 = r4.zzbsx     // Catch:{ all -> 0x0034 }
        ...
        L_0x0016:
            ...
            com.google.android.gms.internal.ads.zzaxy.zzfe(r5)     // Catch:{ all -> 0x0034 }
            monitor-exit(r0)     // Catch:{ all -> 0x0034 }
            return
        L_0x001f:
            com.google.android.gms.internal.ads.zzrf r2 = r4.zzbsw     // Catch:{ all -> 0x0034 }
    ...
    public final Activity getActivity() {
        synchronized (this.zzbsv) {
            ...
            Activity activity = this.zzbsw.getActivity();
            return activity;
        }
    }
    ...
    public final Context getContext() {
        synchronized (this.zzbsv) {
            ...
            Context context = this.zzbsw.getContext();
            return context;
        }
    }
}
