...
public final class zzvo {
    ...
    public zzvo(Context context, AttributeSet attributeSet) {
        ...
        if (z && !z2) {
            this.zzchv = zzcg(string);
        } else if (!z && z2) {
            this.zzchv = zzcg(string2);
        } else if (z) {
