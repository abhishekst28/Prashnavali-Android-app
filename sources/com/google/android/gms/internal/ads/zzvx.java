...
final class zzvx extends zzwf<zzwu> {
    ...
    zzvx(zzvr zzvr, Context context, zzvj zzvj, String str, zzamu zzamu) {
        this.zzchz = zzvr;
    ...
    public final /* synthetic */ Object zzpo() throws RemoteException {
        return this.zzchz.zzcia.zza(this.val$context, this.zzchw, this.zzchx, this.zzchy, 4);
    }

    public final /* synthetic */ Object zza(zzxh zzxh) throws RemoteException {
        return zzxh.zzc(ObjectWrapper.wrap(this.val$context), this.zzchw, this.zzchx, this.zzchy, 202006000);
    }
}
