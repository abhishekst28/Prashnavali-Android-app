...
final class zzei implements zzhd {
    ...
    private zzei(zzeh zzeh) {
        zzeh zzeh2 = (zzeh) zzfe.zza(zzeh, "input");
        this.zza = zzeh2;
        zzeh2.zzc = this;
    }
    ...
    public final <K, V> void zza(Map<K, V> map, zzge<K, V> zzge, zzeq zzeq) throws IOException {
        zza(2);
        ...
        while (true) {
            try {
                ...
                if (zza2 == Integer.MAX_VALUE || this.zza.zzt()) {
                    ...
                    k = zza(zzge.zza, (Class<?>) null, (zzeq) null);
                } else if (zza2 == 2) {
                    v = zza(zzge.zzc, zzge.zzd.getClass(), zzeq);
                } else if (!zzc()) {
