...
final class zzgo {
    ...
    private static void zza(zzgn zzgn, StringBuilder sb, int i) {
        boolean z;
        zzgn zzgn2 = zzgn;
        ...
        for (Method method : zzgn.getClass().getDeclaredMethods()) {
        ...
        for (String str : treeSet) {
            ...
            if (replaceFirst.endsWith("List") && !replaceFirst.endsWith("OrBuilderList") && !replaceFirst.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zza(sb2, i2, zza(concat), zzfd.zza(method2, (Object) zzgn2, new Object[0]));
                }
            }
            if (replaceFirst.endsWith("Map") && !replaceFirst.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zza(sb2, i2, zza(concat2), zzfd.zza(method3, (Object) zzgn2, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? "set".concat(valueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object zza = zzfd.zza(method4, (Object) zzgn2, new Object[0]);
                    if (method5 == null) {
                        if (zza instanceof Boolean) {
                            ...
                            z = zza.equals("");
                        } else if (zza instanceof zzdv) {
                            z = zza.equals(zzdv.zza);
                        } else if (zza instanceof zzgn) {
                            z = zza == ((zzgn) zza).zzv();
                        ...
                        z2 = ((Boolean) zzfd.zza(method5, (Object) zzgn2, new Object[0])).booleanValue();
                    }
                    if (z2) {
        ...
        if (zzgn2 instanceof zzfd.zzb) {
            Iterator<Map.Entry<Object, Object>> zzd = ((zzfd.zzb) zzgn2).zzc.zzd();
            if (zzd.hasNext()) {
                zzd.next().getKey();
                throw new NoSuchMethodError();
            }
        }
        zzfd zzfd = (zzfd) zzgn2;
        if (zzfd.zzb != null) {
            zzfd.zzb.zza(sb2, i2);
        }
    }
