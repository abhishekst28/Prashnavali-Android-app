...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback() {
        public boolean tryCaptureView(View child, int pointerId) {
            ...
            if ((BottomSheetBehavior.this.state != 3 || BottomSheetBehavior.this.activePointerId != pointerId || (scroll = (View) BottomSheetBehavior.this.nestedScrollingChildRef.get()) == null || !scroll.canScrollVertically(-1)) && BottomSheetBehavior.this.viewRef != null && BottomSheetBehavior.this.viewRef.get() == child) {
                return true;
            }
            return false;
        }
